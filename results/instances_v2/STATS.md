...
Both maps pass: exactly one connected component over traversable cells, and
...
| density | warehouse_10_20 (tiles 5577) | warehouse_20_40 (tiles 22358) |
|---|---|---|
| 1% | 56 | 224 |
| 5% | 279 | 1118 |
| 10% | 558 | 2236 |
...
Caveat: warehouse_20_40 scenarios hold 10000 tasks (the cap), so ladder
cells above 10000 agents (45% and up: 10061, 11179, 12297, 13415) exceed
the per-scenario task count and cannot be served by a single s-k file as
generated. Resolve before running those densities (raise the cap or draw
from multiple rollouts); do not silently truncate.
...
- Higher densities neither complete nor trip the all-stalled break; they
  ...
  20_40 smoke N=1118/6707/13415 killed at 550 s.
- Consequence: e0_quick.golden holds the 4 warehouse cells that terminate
  deterministically; the 6 mandated higher-density cells are excluded
  until the livelock is addressed.
