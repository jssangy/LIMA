...
def main() -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "use the unique cyclic-goal scenarios generated by the classic "
            "baseline runner instead of the submitted repeated-sink scenarios"
        ),
    )
    ...
    for map_name in maps:
        ...
        for density in densities:
            ...
            for scenario in scenarios:
                if args.classic_scenarios:
                    scenario_file = (
                        "results/classic_pibt_300s/instances/scenarios/"
                        f"{map_name}_d{density:02d}_a{agents}_s{scenario}.scen"
                    )
                else:
    ...
    manifest = {
        ...
        "classic_scenarios": args.classic_scenarios,
