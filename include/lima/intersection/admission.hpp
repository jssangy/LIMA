...
struct AimdIntersectionObservation {
    ...
    // Optional one-hop information-axis signal.  This augments structural
    // congestion without changing the acknowledged-grant lifecycle.
    bool information_congested{};
};
